...
import { FiMapPin, FiX, FiFilter } from 'react-icons/fi';
                            ...
                            <div className="space-y-2">
                                {sortOptions.map((option) => (
                                    <button
                                        ...
                                        className={`w-full text-left p-2 hover:bg-gray-100 rounded flex items-center justify-between ${selectedSort === option.value ? 'bg-gray-50' : ''
                                            }`}
                                    >
                                        <span>{option.label}</span>
                                        {selectedSort === option.value && (
                                            <svg className="w-4 h-4 text-[#20bead]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
